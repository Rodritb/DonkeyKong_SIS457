...
FVector ADonkeyKong_SIS457Character::GetCurrentPosition() const
{
	return FVector();
}
...
void ADonkeyKong_SIS457Character::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("FireRight", this, &ADonkeyKong_SIS457Character::FireRight);
	PlayerInputComponent->BindAxis("FireLeft", this, &ADonkeyKong_SIS457Character::FireLeft);
...
{
	//LA POSICION DEL PERSONAJE AL INICIAR EL JUEGO, SPAWNEA ARRIBA ENCIMA DE UNA PLATAFORMA
	Super::BeginPlay();
...
void ADonkeyKong_SIS457Character::FireShot(FVector _Direction)
{
...
void ADonkeyKong_SIS457Character::FireRight(float Val)
{
...
void ADonkeyKong_SIS457Character::FireLeft(float Val)
{
...
void ADonkeyKong_SIS457Character::NotifyHit(UPrimitiveComponent* MyComp, AActor* Other, UPrimitiveComponent* OtherComp, bool bSelfMoved, FVector HitLocation, FVector HitNormal, FVector NormalImpulse, const FHitResult& Hit)
{
    ...
    if (Other->IsA(AMuroHielo::StaticClass()))
    {
        ...
        GetWorldTimerManager().SetTimer(TimerHandle, this, &ADonkeyKong_SIS457Character::ReanudarMovimiento, 2.0f, false);
    }
}
/*cuando toca el personaje y se congela, la funcion hace que el personaje se mueva nuevamente*/
void ADonkeyKong_SIS457Character::ReanudarMovimiento()
{
